...
### Volgorde na T2 (per sessie)
Na T2 komen altijd in deze volgorde:
1. **REV** — revalidatie/correctieve oefeningen (Rathleff Heel Raise voor Hallux Rigidus voetboogversterking, **niet** Achilles)
2. **T3 Variaties** — dynamisch gerangschikte oefeningen uit de dag-pool (Hip Thrust, Lat PD, Cable Row, enz.)
3. **T3 Aanvulling** — full body supplementary (Situps, Crunches, enz.) → ook badge `T3`
